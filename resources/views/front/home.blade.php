    ...
    <main class="ps-main">
        <div class="ps-banner">
            <div class="rev_slider fullscreenbanner" id="home-banner">
                <ul>
                    <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" href="{{ asset('asset/images/slider/3.jpg') }}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
                    ...
                    <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" href="{{ asset('asset/images/slider/2.jpg') }}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
                ...
                <div class="ps-section__content pb-50">
                    <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
                        <div class="ps-masonry">
                            ...
                            <div class="grid-item col-md-3 {{ $prod->category->slug }}">
                                <div class="grid-item__content-wrapper">
                                    <div class="ps-shoe mb-30">
                                        <div class="ps-shoe__thumbnail">
                                            <div class="ps-badge"><span>New</span></div>
                                            <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ $prod->image_url }}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                                        </div>
                                        <div class="ps-shoe__content">
                                            <div class="ps-shoe__variants">
                                                <div class="ps-shoe__variant normal"><img src="{{ asset('asset/images/shoe/2.jpg') }}" alt=""><img src="{{ asset('asset/images/shoe/3.jpg') }}" alt=""><img src="{{ asset('asset/images/shoe/4.jpg') }}" alt=""><img src="{{ asset('asset/images/shoe/5.jpg') }}" alt=""></div>
                                            ...
                                            <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">{{$prod->name}}</a>
                                                <p class="ps-shoe__categories"><a href="#">{{$prod->category->name}}</a></p><span class="ps-shoe__price">
                                                    <del>£{{$prod->price}}</del> £ {{$prod->sale_price}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                            <div class="ps-hotspot"><a class="point first active" href="javascript:;"><i class="fa fa-plus"></i>
                                ...
                                </a><img src="{{ asset('asset/images/hot-deal.png') }}" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
